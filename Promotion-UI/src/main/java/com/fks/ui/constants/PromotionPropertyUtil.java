...
public class PromotionPropertyUtil
{
    ...
    private static final Logger logger = LogManager.getLogger(PromotionPropertyUtil.class.getName());
    ...
    static
    {
        ...
        {
            logger.traceEntry(PromotionPropertyUtil.class.getName());
            LogManager.getLogger(Level.ERROR,null);
            logger.catching(ex);
        } finally
        {
            if (is != null)
